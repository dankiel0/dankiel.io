...
import project2 from './img/chess_board_glass_black_white_surface_15259_800x600.jpg';
import project3 from './img/codescreen.png';
                ...
                <section className="about-me-section p-3 p-lg-5 theme-bg-light">
                    <div className="container">
                        <div className="profile-teaser row">
                            ...
                            <div className="col">
                                <h2 className="name font-weight-bold mb-1">Daniel Khrapko</h2>
                                <div className="tagline mb-3">Computer Science Student</div>
                                <div className="bio mb-4">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam luctus tortor dolor, eu faucibus turpis viverra ut. In non lorem elementum on&nbsp;

                                    <Link to="/blog" className="text-link">
                                        my blog.
                                    </Link>
                                    &nbsp;Lorem ipsum dolor sit amet, consectetur. Check out my&nbsp;
                                ...
                                <div className="mb-4">
                                    <Link to="/portfolio" className="btn btn-primary me-2 mb-3">
                                        <svg className="svg-inline--fa fa-arrow-alt-circle-right fa-w-16 me-2"
                                             aria-hidden="true" focusable="false" data-prefix="fas"
                                             data-icon="arrow-alt-circle-right" role="img"
                                    ...
                                    <Link to="/resume" className="btn btn-secondary mb-3">
                                        <svg className="svg-inline--fa fa-file-alt fa-w-12 me-2" aria-hidden="true"
                                             focusable="false" data-prefix="fas" data-icon="file-alt" role="img"
                                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
                                            <path fill="currentColor"
                                                  d="M224 136V0H24C10.7 0 0 10.7 0 24v464c0 13.3 10.7 24 24 24h336c13.3 0 24-10.7 24-24V160H248c-13.2 0-24-10.8-24-24zm64 236c0 6.6-5.4 12-12 12H108c-6.6 0-12-5.4-12-12v-8c0-6.6 5.4-12 12-12h168c6.6 0 12 5.4 12 12v8zm0-64c0 6.6-5.4 12-12 12H108c-6.6 0-12-5.4-12-12v-8c0-6.6 5.4-12 12-12h168c6.6 0 12 5.4 12 12v8zm0-72v8c0 6.6-5.4 12-12 12H108c-6.6 0-12-5.4-12-12v-8c0-6.6 5.4-12 12-12h168c6.6 0 12 5.4 12 12zm96-114.1v6.1H256V0h6.1c6.4 0 12.5 2.5 17 7l97.9 98c4.5 4.5 7 10.6 7 16.9z"></path>
                                        </svg>
                                        <span
                                            className="d-none d-md-inline">View </span>
                                        Resume
                                    </Link>
                                </div>
                            </div>
                            ...
                            <div className="col-md-5 col-lg-5">
                                <img className="profile-image img-fluid mb-3 mb-lg-0 me-md-0" src={blackbox} alt=""/>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="overview-section p-3 p-lg-5">
                    <div className="container">
                        ...
                        <div className="section-intro mb-5">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam luctus tortor dolor, eu faucibus turpis viverra ut. In non lorem elementum, malesuada mi vitae, semper risus. Vestibulum ante ipsum primis in faucibus orci luctus&nbsp;
                        ...
                        <div className="row">
                            <div className="item col-6 col-lg-3">
                                <div className="item-inner">
                                    <div className="item-icon">
                                        <svg className="svg-inline--fa fa-js-square fa-w-14" aria-hidden="true"
                                             focusable="false" data-prefix="fab" data-icon="js-square" role="img"
                                    ...
                                    <div className="item-desc">
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam luctus tortor dolor, eu faucibus turpis viverra ut. In non lorem elementum.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="item col-6 col-lg-3">
                                <div className="item-inner">
                                    <div className="item-icon">
                                        <svg className="svg-inline--fa fa-html5 fa-w-12 me-2" aria-hidden="true"
                                        ...
                                        <svg className="svg-inline--fa fa-css3-alt fa-w-12" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="css3-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
                            ...
                            <div className="item col-6 col-lg-3">
                                <div className="item-inner">
                                    <div className="item-icon">
                                        <svg className="svg-inline--fa fa-react fa-w-16 me-2" aria-hidden="true"
                            ...
                            <div className="item col-6 col-lg-3">
                                <div className="item-inner">
                                    <div className="item-icon">
                                        <svg className="svg-inline--fa fa-node-js fa-w-14" aria-hidden="true"
                            ...
                            <div className="item col-6 col-lg-3">
                                <div className="item-inner">
                                    <div className="item-icon">
                                        ...
                                        <svg className="svg-inline--fa fa-c fa-w-18" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="c" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 38.000089 42.000031" data-fa-i2svg="">
                                        ...
                                        <svg className="svg-inline--fa fa-c fa-w-18" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="cpp" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 306 344.35" data-fa-i2svg="">
                                    ...
                                    <h3 className="item-title">C/C++</h3>
                            ...
                            <div className="item col-6 col-lg-3">
                                <div className="item-inner">
                                    <div className="item-icon">
                                        ...
                                        <svg className="svg-inline--fa fa-java fa-w-14" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="java" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
                            ...
                            <div className="item col-6 col-lg-3">
                                <div className="item-inner">
                                    <div className="item-icon">
                                        <svg className="svg-inline--fa fa-python fa-w-14" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="python" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                            ...
                            <div className="item col-6 col-lg-3">
                                <div className="item-inner">
                                    <div className="item-icon">
                                        ...
                                        <svg className="svg-inline--fa fa-git-alt fa-w-14" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="git-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                            <path fill="currentColor" d="M439.55 236.05L244 40.45a28.87 28.87 0 0 0-40.81 0l-40.66 40.63 51.52 51.52c27.06-9.14 52.68 16.77 43.39 43.68l49.66 49.66c34.23-11.8 61.18 31 35.47 56.69-26.49 26.49-70.21-2.87-56-37.34L240.22 199v121.85c25.3 12.54 22.26 41.85 9.08 55a34.34 34.34 0 0 1-48.55 0c-17.57-17.6-11.07-46.91 11.25-56v-123c-20.8-8.51-24.6-30.74-18.64-45L142.57 101 8.45 235.14a28.86 28.86 0 0 0 0 40.81l195.61 195.6a28.86 28.86 0 0 0 40.8 0l194.69-194.69a28.86 28.86 0 0 0 0-40.81z" className=""></path>
                                        </svg>
                    ...
                    <div className="container">
                                ...
                                <div className="card project-card">
                                    <div className="row no-gutters">
                                        <div className="col-12 col-xl-5 card-img-holder">
                                            <img src={project3} className="card-img" alt="image"/>
                                        </div>
                                        <div className="col-12 col-xl-7">
                                            <div className="card-body">
                                                <h5 className="card-title">
                                                    <Link to="/portfolio" className="theme-link">
                                                        Project 1 Name
                                                    </Link>
                                                </h5>
                                                <p className="card-text">
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus mollis ligula in gravida vehicula. Nullam consequat suscipit ante vel scelerisque. Vivamus molestie vehicula metus ac congue.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="text-center py-3">
                            <Link to="/portfolio" className="btn btn-primary">
                                <svg className="svg-inline--fa fa-arrow-alt-circle-right fa-w-16 me-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="arrow-alt-circle-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                        ...
                        <div className="row">
                            <div className="col-md-4 mb-5">
                                <div className="card blog-post-card">
                                    <img className="card-img-top" src={project2} alt="image"/>
                                        <div className="card-body">

                                            <h5 className="card-title">
                                                <Link to="/blog" className="theme-link">
                                                    Generic Blog 1 Title
                                                </Link>
                                            </h5>
                                        ...
                                        <div className="card-footer">
                                            <small className="text-muted">Published Oct 9, 2021</small>
                                        </div>
                                </div>
                            </div>
                            <div className="col-md-4 mb-5">
                                <div className="card blog-post-card">
                                    <img className="card-img-top" src={project2} alt="image"/>
                                        ...
                                        <div className="card-footer">
                                            <small className="text-muted">Published Sep 21, 2021</small>
                                        </div>
                                </div>
                            </div>
                            <div className="col-md-4 mb-5">
                                <div className="card blog-post-card">
                                    <img className="card-img-top" src={project2} alt="image"/>
                                        ...
                                        <div className="card-footer">
                                            <small className="text-muted">Published Aug 5, 2021</small>
                                        </div>
                                </div>
                            </div>
                        </div>
